...
package jdk.internal.math.fastdoubleparser;
...
//        try {  // chegar: commented out fallback for verification purposes
...
//    }
    ...
    private static double parseRestOfDecimalFloatLiteralTheHardWay(CharSequence str, int startIndex, int endIndex) {
        ...
        return FloatingDecimal.parseDouble(str.subSequence(startIndex, endIndex).toString());
    }
    ...
    private static double parseRestOfHexFloatingPointLiteral(
        ...
        return Double.isNaN(d) ? FloatingDecimal.parseDouble(str.toString()) : d;  // <<< HERE
    }
